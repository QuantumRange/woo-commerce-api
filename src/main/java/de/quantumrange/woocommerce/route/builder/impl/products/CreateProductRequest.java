...
public class CreateProductRequest extends PostRequestBuilder<Product> {
	 ...
	 *
	 * @param name Controls the stock status of the product. Options: instock, outofstock, onbackorder. Default is instock.
	 * @return itself
	 */
	public CreateProductRequest setName(String name)  {
		put("backorders",  null);
